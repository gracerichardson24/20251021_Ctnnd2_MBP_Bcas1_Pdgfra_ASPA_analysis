...
```{r}
PposApos = lm(P_pos_A_pos ~ bin + Genotype + bin:Genotype,
           data = combined_detections_ASPA_Pdgfrabinned_counts)
print(summary(PposApos))
Anova(PposApos, type = "II")



PposAneg = lm(P_pos_A_neg ~ bin + Genotype + bin:Genotype,
           data = combined_detections_ASPA_Pdgfrabinned_counts)
print(summary(PposAneg))
Anova(PposAneg, type = "II")




PnegApos = lm(P_neg_A_pos ~ bin + Genotype + bin:Genotype,
           data = combined_detections_ASPA_Pdgfrabinned_counts)
print(summary(PnegApos))
Anova(PnegApos, type = "II")



PnegAneg = lm(P_neg_A_neg ~ bin + Genotype + bin:Genotype,
           data = combined_detections_ASPA_Pdgfrabinned_counts)
print(summary(PnegAneg))
