...
MBPprop_plot_gt <- animal_frame_BCas1MBP_prop %>%
  ...
  mutate(
    CellType = dplyr::recode(
      CellType,
      prop_Bcas1_MBPneg = "Bcas1+/MBP-",
      prop_Bcas1_MBPpos = "Bcas1+/MBP+"
    )
  ) %>%
  ggplot(aes(x = Genotype, y = Proportion, fill = CellType)) +
  geom_bar(stat = "identity") +
  theme_classic() +
  scale_fill_manual(values = c("Bcas1+/MBP-" = "#00FFFF",
                               "Bcas1+/MBP+" = "#FF0000")) +
  labs(x = "", y = "Proportion", fill = "")

ggsave("MBPgt_propplot.png", plot = MBPprop_plot_gt, width = 6, height = 4, dpi = 300)
...
MBPprop_plot_animal <- animal_frame_BCas1MBP %>%
  ...
  scale_fill_manual(values = c(
    "Bcas1+/MBP-" = "#00FFFF",  # cyan
    "Bcas1+/MBP+" = "#FF0000"   # red
  )) +
  theme_classic() +
  labs(x = "Animal", y = "Proportion", fill = "") +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))

ggsave("MBPani_propplot.png", plot = MBPprop_plot_animal, width = 6, height = 4, dpi = 300)
